				...
				sections = {
					'demonizer': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-096KB8HCX2', { 'page_path': '/#demonizer' });
								},
							],
						},
					},
					'demonizer-bonus': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-096KB8HCX2', { 'page_path': '/#demonizer-bonus' });
								},
							],
						},
					},
					'honey-soldier': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-096KB8HCX2', { 'page_path': '/#honey-soldier' });
								},
							],
						},
					},
					'links': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-096KB8HCX2', { 'page_path': '/#links' });
								},
							],
						},
					},
					'contact': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-096KB8HCX2', { 'page_path': '/#contact' });
								},
							],
						},
					},
					'donate': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-096KB8HCX2', { 'page_path': '/#donate' });
								},
							],
						},
					},
					'home': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-096KB8HCX2', { 'page_path': '/' });
								},
							],
						},
					},
